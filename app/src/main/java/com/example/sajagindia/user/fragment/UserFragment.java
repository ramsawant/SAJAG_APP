...
import com.example.sajagindia.MainActivitys;
import com.example.sajagindia.Models.UserModel;
import com.example.sajagindia.R;
import com.example.sajagindia.dashboard;
...
//        name taking from database
        if (uAuth != null) {
            ...
            binding.sajagProfile.setOnClickListener(v -> {
...
//        ----------profile_vist-----
    ...
    void logOutFuc() {
        binding.logout.setOnClickListener(view -> {
            ...
            Intent inte = new Intent(getContext(), MainActivitys.class);
            startActivity(inte);
            requireActivity().finish();
